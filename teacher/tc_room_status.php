...
<div class="right_col" role="main">
    <div class="request-status-container">
        ...
        <div>
            ...
            $countSql = "SELECT Status, COUNT(*) as Count FROM room_requests WHERE TeacherID = ? GROUP BY Status"; // Changed StudentID to TeacherID
            ...
            <div class="request-list">
                <?php
                // Query to get teacher's room requests
                ...
                ?>
                    ...
                    <div class="empty-state">
                        ...
                        <a href="tc_browse_room.php" class="btn-next">Make a Reservation</a>
                    </div>
                <?php
                }

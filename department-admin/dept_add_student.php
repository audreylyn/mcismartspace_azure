    ...
    <div id="app">
        ...
        <div class="main-container">
            ...
            <?php if ($success_message): ?>
                <div class="custom-alert success"><?php echo htmlspecialchars($success_message); ?></div>
            <?php endif; ?>

            <?php if ($error_message): ?>
                <div class="custom-alert error"><?php echo htmlspecialchars($error_message); ?></div>
            <?php endif; ?>
                                ...
                                <?php else: ?>
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td data-label="YearSection"><?= htmlspecialchars($row['YearSection']) ?></td>
            ...
            <div class="fixed-form-container">
                <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" class="form-grid">
                    <div class="form-row">
                        <input class="input" type="text" name="first_name" placeholder="First Name" pattern="[A-Za-z\s]+" required>
                        <input class="input" type="text" name="last_name" placeholder="Last Name" pattern="[A-Za-z\s]+" required>
                        <input class="input" type="text" name="yearsection" placeholder="Year & Section" required>
                    </div>
